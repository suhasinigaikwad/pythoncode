...
test_index = [1,51,101]                               #here taken all variety of flowers

# Training data with removed elements
train_target = np.delete(iris.target,test_index)        #labels
train_data = np.delete(iris.data,test_index,axis=0)     #features
